...
if ( ! function_exists( 'shortcode_lister_menu' ) ) {
...
if ( ! function_exists( 'shortcode_lister_admin_settings_setup' ) ) {
...
if ( ! function_exists( 'shortcode_lister_add_action_links' ) ) {
...
if ( ! function_exists( 'shortcode_lister_admin_settings_page' ) ) {
...
if ( ! function_exists( 'shortcode_lister_welcome_tab' ) ) {
...
if ( ! function_exists( 'shortcode_lister_welcome_render_options_page' ) ) {
...
if ( ! function_exists( 'shortcode_lister_register_settings' ) ) {
...
if ( ! function_exists( 'shortcode_lister_sanitize_settings' ) ) {
	function shortcode_lister_sanitize_settings( $input ) {
		global $shortcode_tags;

		if ( ! current_user_can( 'manage_options' ) ) {
			return get_option( 'shortcode_lister_settings', array() );
		}
